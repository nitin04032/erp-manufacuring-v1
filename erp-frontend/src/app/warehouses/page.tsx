...
// ### MUKHYA SUDHAR 1: INTERFACE UPDATE ###
// Interface ko backend ke 'warehouse.entity.ts' jaisa banaya gaya hai
interface Warehouse {
  id: number;
  code: string;
  name: string;
  ...
  is_active: boolean; // 'status' ki jagah 'is_active'
}
                ...
                <div className="card-body">
                    <form className="row g-3">
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" id="search" className="form-control" placeholder="Search by name, code..." value={search} onChange={(e) => setSearch(e.target.value)} />
                        </div>
                        <div className="col-md-3 d-flex align-items-end gap-2">
                             <button type="button" className="btn btn-outline-primary" onClick={fetchWarehouses}>
                        ...
                        <div className="table-responsive">
                            <table className="table table-hover">
                                ...
                                <tbody>
                                    {warehouses.map((w) => (
                                    <tr key={w.id}>
                                        {/* ### MUKHYA SUDHAR 2: SAHI PROPERTY NAMES ### */}
